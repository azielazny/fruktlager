...
//
//    private Address address = new Address("Zenek", "Testowy", "ul. Zabłocka 11", "", "Poland", "Gdańsk", "80-001", "+475555555");
//    private Area area = new Area("Ulvik");
//
//    private Member fullDataMember = new Member(11, address, MemberType.PRODUCER, "test@test.com", "hasło", area, "testowyLogin");
//    private Member correspondenceDataMember = new Member(address, MemberType.PRODUCER, area);
//
//    //edytować dane+
...
//        // when
//        fullDataMember.editMemberData(new Member(address, MemberType.PRODUCER, area));
//
//        // then
//        assertThat(fullDataMember.getMemberData()).isEqualTo(new Member(address, MemberType.PRODUCER, area));
//    }
//
//    @Test
